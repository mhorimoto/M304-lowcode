...
const char* const str_opeRTC[] PROGMEM = {str_opeRTC0, str_opeRTC1,
                                          str_opeRTC2, str_opeRTC3,
                                          str_opeRTC4, str_opeRTC5};
...
void opeRTC(void) {
    ...
    if (ptr_crosskey->kpos & K_ENT) {
        ntpAccess();
        snprintf(line1, 21, "%d/%02d/%02d  %02d:%02d:%02d", tm.Year + 1970,
